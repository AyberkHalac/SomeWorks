		...
		if (Classes.A_CLASS.size() != 0) {
			for (Classes.A cls : Classes.A_CLASS) {
				if (teacherList2.size() != 0) {
					...
					while (!isEmptyA(teacher, type, day)
							|| !isLessonOK_UpperA(cls, type, day, array,
									teacherCount)) {
						type = rnd.nextInt(2);
						day = rnd.nextInt(5);
					}
					if (type == 0) {
						...
						teacher.getTeacherSchedule()[day][4] = "MC / A-"
								+ Classes.A_CLASS.indexOf(cls);
						teacher.getTeacherSchedule()[day][5] = "MC / A-"
								+ Classes.A_CLASS.indexOf(cls);
						cls.schedule[day][2] = "MC / " + teacher.getName();
						cls.schedule[day][3] = "MC / " + teacher.getName();
							...
							for (int i = 0; i < 4; i++) {
								if (days[i][1] == 2) {
									...
									teacher.getTeacherSchedule()[days[i][0]][4] = "RW / A-"
											+ Classes.A_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][5] = "RW / A-"
											+ Classes.A_CLASS.indexOf(cls);
						...
						if (totalCount == 2) {
							for (int i = 0; i < 2; i++) {
								if (days[i][1] == 2) {
									...
									teacher.getTeacherSchedule()[days[i][0]][4] = "LS / A-"
											+ Classes.A_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][5] = "LS / A-"
											+ Classes.A_CLASS.indexOf(cls);
									cls.schedule[days[i][0]][4] = "LS / "
											+ teacher.getName();
									cls.schedule[days[i][0]][5] = "LS / "
