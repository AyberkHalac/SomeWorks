...
public class C {
				...
				while (teacherList2.size() != 0 && list.size() != 0
					...
					while (counter != 2) {
						...
						if (FAULT == 20)
							break;
						if (type == 0) {
							teacher.getTeacherSchedule()[day][0] = "MC / C-"
									+ Classes.C_CLASS.indexOf(cls);
							teacher.getTeacherSchedule()[day][1] = "MC / C-"
									+ Classes.C_CLASS.indexOf(cls);
						...
						if (type == 1) {
							...
							teacher.getTeacherSchedule()[day][3] = "MC / C-"
									+ Classes.C_CLASS.indexOf(cls);
							teacher.getTeacherSchedule()[day][4] = "MC / C-"
									+ Classes.C_CLASS.indexOf(cls);
							cls.schedule[day][2] = "MC / " + teacher.getName();
	...
	public static void addRWC(ArrayList<Teacher> teacherList2) {
		...
		ArrayList<Teacher> list = new<Teacher> ArrayList();
		Random rnd = new Random();
		if (Classes.C_CLASS.size() != 0 && control == true) {
			for (Classes.C cls : Classes.C_CLASS) {
				list.addAll(teacherList2);
					...
					while (totalCount != 4 && control == true) {
						...
						for (int i = 0; i < 5; i++) {
							...
							if (cls.lesson[i] == 2 || cls.lesson[i] == 0) {
								day = i;
								while (!isEmpty(teacher, type, day)
										|| !isLessonOK_UpperC(cls, type, day,
												array, teacherCount)) {
									type++;
									if (type == 2) {
										break;
						...
						if (totalCount == 4) {
							for (int i = 0; i < 4; i++) {
								if (days[i][1] == 0) {
									teacher.getTeacherSchedule()[days[i][0]][0] = "RW / C-"
											+ Classes.C_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][1] = "RW / C-"
											+ Classes.C_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][2] = "RW / C-"
											+ Classes.C_CLASS.indexOf(cls);
									...
									teacher.getTeacherSchedule()[days[i][0]][2] = "RW / C-"
											+ Classes.C_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][3] = "RW / C-"
											+ Classes.C_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][4] = "RW / C-"
											+ Classes.C_CLASS.indexOf(cls);
									cls.schedule[days[i][0]][2] = "RW / "
											+ teacher.getName();
				...
				if (teacherList2.size() != 0 && list.size() != 0
					...
					while (totalCount != 2) {
						...
						if (totalCount == 2) {
							for (int i = 0; i < 2; i++) {
								if (days[i][1] == 0) {
									teacher.getTeacherSchedule()[days[i][0]][0] = "LS / C-"
											+ Classes.C_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][1] = "LS / C-"
											+ Classes.C_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][2] = "LS / C-"
											+ Classes.C_CLASS.indexOf(cls);
									...
									teacher.getTeacherSchedule()[days[i][0]][2] = "LS / C-"
											+ Classes.C_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][3] = "LS / C-"
											+ Classes.C_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][4] = "LS / C-"
											+ Classes.C_CLASS.indexOf(cls);
									cls.schedule[days[i][0]][2] = "LS / "
											+ teacher.getName();
