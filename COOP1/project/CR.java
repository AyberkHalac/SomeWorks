...
public class CR {
	 ...
	 * @param teacherList2
	 */
	public static void addMCCR(ArrayList<Teacher> teacherList2) {
		ArrayList<Teacher> list = new<Teacher> ArrayList();
		Random rnd = new Random();
		if (Classes.CR_CLASS.size() != 0) {
			for (Classes.CR cls : Classes.CR_CLASS) {
				...
				while (teacherList2.size() != 0 && list.size() != 0
					...
					while (canTakeThisLevel(teacher, "CR") == false
					...
					while (counter != 2) {
						...
						while (isEmpty(teacher, type, day) == false
								|| isLessonOK_UpperCR(cls, type, day, array, 1) == false) {
						...
						if (FAULT == 20)
							break;
						if (type == 0) {
							teacher.getTeacherSchedule()[day][0] = "MC / CR-"
									+ Classes.CR_CLASS.indexOf(cls);
							teacher.getTeacherSchedule()[day][1] = "MC / CR-"
									+ Classes.CR_CLASS.indexOf(cls);
							teacher.getTeacherSchedule()[day][2] = "MC / CR-"
									+ Classes.CR_CLASS.indexOf(cls);
						...
						if (type == 1) {
							teacher.getTeacherSchedule()[day][2] = "MC / CR-"
									+ Classes.CR_CLASS.indexOf(cls);
							teacher.getTeacherSchedule()[day][3] = "MC / CR-"
									+ Classes.CR_CLASS.indexOf(cls);
							teacher.getTeacherSchedule()[day][4] = "MC / CR-"
									+ Classes.CR_CLASS.indexOf(cls);
							cls.schedule[day][2] = "MC / " + teacher.getName();
	 ...
	 * @param teacherList2
	 */
	public static void addRWCR(ArrayList<Teacher> teacherList2) {

		int teacherCount = 2;
		int totalCount = 0;
		ArrayList<Teacher> list = new<Teacher> ArrayList();
		Random rnd = new Random();
		if (Classes.CR_CLASS.size() != 0 && control == true) {
			for (Classes.CR cls : Classes.CR_CLASS) {
				list.addAll(teacherList2);
				if (teacherList2.size() != 0 && list.size() != 0) {
					while (totalCount != 4 && control == true) {
						...
						while (!canTakeThisLevel(teacher, "CR")
								|| !canTakeThisLessonType(teacher, "RW")
								|| teacher.getCourseHour() < 10
								|| teacher.equals(cls.t1.getName())) {
							list.remove(teacher);
							if (list.size() > 0)
						...
						for (int i = 0; i < 5; i++) {
							...
							if (cls.lesson[i] == 2 || cls.lesson[i] == 0) {
								...
								while (!isEmpty(teacher, type, day)
										|| !isLessonOK_UpperCR(cls, type, day,
												array, teacherCount)) {
									type++;
									if (type == 2) {
										break;
						...
						if (totalCount == 4) {
							for (int i = 0; i < 4; i++) {
								if (days[i][1] == 0) {
									teacher.getTeacherSchedule()[days[i][0]][0] = "RW / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][1] = "RW / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][2] = "RW / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									...
									teacher.getTeacherSchedule()[days[i][0]][2] = "RW / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][3] = "RW / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][4] = "RW / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									cls.schedule[days[i][0]][2] = "RW / "
											+ teacher.getName();
	 ...
	 * @param teacherList2
	 */
	public static void addLSCR(ArrayList<Teacher> teacherList2) {
				...
				if (teacherList2.size() != 0 && list.size() != 0
					...
					while (totalCount != 2) {
						...
						while (!canTakeThisLevel(teacher, "CR")
								...
								|| (teacher.equals(cls.t1.getName()) && teacher
										.equals(cls.t2.getName()))) {
							list.remove(teacher);
							if (list.size() != 0)
								teacher = list.get((int) rnd.nextInt(list
										.size() + 0));
						...
						if (totalCount == 2) {
							for (int i = 0; i < 2; i++) {
								if (days[i][1] == 0) {
									teacher.getTeacherSchedule()[days[i][0]][0] = "LS / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][1] = "LS / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][2] = "LS / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									...
									teacher.getTeacherSchedule()[days[i][0]][3] = "LS / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									teacher.getTeacherSchedule()[days[i][0]][4] = "LS / CR-"
											+ Classes.CR_CLASS.indexOf(cls);
									cls.schedule[days[i][0]][2] = "LS / "
											+ teacher.getName();
	 ...
	 * @return
	 */
	private static boolean isLessonOK_UpperCR(Classes.CR cls, int type,
